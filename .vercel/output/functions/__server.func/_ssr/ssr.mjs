...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-_YeqjUO8.mjs");
...
var manifest = {
	"23a15c312258973e60ec5cd1537560033fd7256d8035479dbe036397f1abdfcb": {
		functionName: "fetchFieldDefs_createServerFn_handler",
		importer: () => import("./server-fns-CEYe764T.mjs")
	},
	"2e256ca39484427682455e1daf618775ec4255e331dc410bef69bf71215eb757": {
		functionName: "commitWriteFn_createServerFn_handler",
		importer: () => import("./server-fns-CEYe764T.mjs")
	},
	"2e5e47f22c2cfb469e06b06df35ca3b1db54a1a776ebc199cd1b1ae99f6d229b": {
		functionName: "prepareWriteFn_createServerFn_handler",
		importer: () => import("./server-fns-CEYe764T.mjs")
	},
	"660d6d21ed950c27dc1ea6027588fee0201686436691a3334d32dc611c005c2b": {
		functionName: "fetchJobs_createServerFn_handler",
		importer: () => import("./server-fns-CEYe764T.mjs")
	},
	"8baa685b24065de7921acc717be294e76bc1f8330c2caba801a256f49943d851": {
		functionName: "pingKeys_createServerFn_handler",
		importer: () => import("./server-fns-CEYe764T.mjs")
	},
	"974aa90e1590198c4baf132130432b180b0536c8609617de6488d6736b3d11e8": {
		functionName: "extractQuoteFn_createServerFn_handler",
		importer: () => import("./server-fns-CEYe764T.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DZ49iCrW.mjs").then((n) => n.t),
